...
public class Assignment {
    public static void main(String[] args) {
        ...
        // += 연산자
        int num1 = 10;
        System.out.println("num1 초기값: " + num1);
        num1 += 5; // num1 = num1 + 5;
        System.out.println("num1 += 5: " + num1); // 15

        // -= 연산자
        int num2 = 20;
        System.out.println("num2 초기값: " + num2);
        num2 -= 8; // num2 = num2 - 8;
        System.out.println("num2 -= 8: " + num2); // 12

        // *= 연산자
        int num3 = 5;
        System.out.println("num3 초기값: " + num3);
        num3 *= 3; // num3 = num3 * 3;
        System.out.println("num3 *= 3: " + num3); // 15

        // /= 연산자
        int num4 = 20;
        System.out.println("num4 초기값: " + num4);
        num4 /= 4; // num4 = num4 / 4;
        System.out.println("num4 /= 4: " + num4); // 5

        // %= 연산자
        int num5 = 17;
        System.out.println("num5 초기값: " + num5);
        num5 %= 5; // num5 = num5 % 5;
