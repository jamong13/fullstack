...
public class MemoPad {
    private static final String OUTPUT_FILE = "c:/Users/limeh/memo/out2.txt";//C:\Users\limeh
    // 맨 처음에는 파일, 폴더 없음
        ...
        private static void appendMemo(Scanner sc) {
            System.out.println("추가 메모 내용 입력(종료: 빈 줄 입력)");
            ...
            File parentDir = outputFile.getParentFile(); // c:/Users/limeh/memo/
        ...
        private static void writeNewMemo(Scanner sc) {
            ...
            // 파일 존재 여부 확인
            boolean fileExists = outputFile.exists(); // c:/Users/limeh/memo/out2.txt
