...
public class AccountManager {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    try {
                        int initialBalance = sc.nextInt(); // 초기 입금액
                        sc.nextLine();
                ...
                case 2:
                    ...
                    try {
                        ...
                        System.out.println("입금할 금액은 숫자로 입력하세요");
                        sc.nextLine();
                    }
                break;
                ...
                case 3:
                    ...
                    try {
                        ...
                        System.out.println("출금할 금액은 숫자로 입력하세요");
                        sc.nextLine();
                    }
                break;
    ...
    private Account findAccountByNumber(String accountNumber) {
        for(Account account : accounts){
            if(account.getAcccountNumber().equals(accountNumber)){
                return account;
            }
        }
        return null;
    ...
    private void findAccount(String searchAccount) {
        ...
        if(account !=null){
            ...
            System.out.println("계좌번호: " + account.getAcccountNumber());
