...
public class Main1 {
    public static void main(String[] args) {
        ...
        // 문제 1. 2011년에 일어난 모든 트랜잭션을 찾아 오름차순으로 정렬
        ...
        // 문제 4. 밀라노엔 거래자가 있는지 유무
        practice4(transactions);
        // 문제 5. 케임브리지 거주하는 모든 트랜잭션값 출력
    ...
    private static void practice7(List<Transaction> transactions) {
        Transaction result = transactions.stream()
            ...
            .orElse(null);
            // 값이 없으면 null 있으면 객체 반환 (min인 max는 null값 처리)
            System.out.println(result);
    }
...
// Transaction::getValue는 t -> t.getValue() - Transaction 객체에서 value값을 꺼내라
