...
public class Stream2 {
    ...
    //         .isPresent(); // 있으면 true 값이 updated에 저장됨
    //     System.out.println(updated ? "학생 ID " + id + " 정보 수정되었습니다." : "학생 ID " + id + "를 찾을 수 없습니다.");
    ...
    private static Student_1 searchStudent(List<Student_1> studentList, int id) {
        return studentList.stream()
            .filter(student -> student.getId() == id)
            .findFirst() // 여러 개 찾아도 그 중 제일 처음 것
            .orElse(null);
    }
