  ...
  return (
   <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto px-4 mt-8">
        <div className="flex flex-wrap gap-2 bg-white p-2 rounded-lg shadow-xs">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              ...
              className={`px-6 py-3 rounded-md font-semibold transition-all duration-200 ${
                activeTab === tab.id
                  ? 'bg-linear-to-r from-blue-500 to-purple-500 text-white shadow-lg transform scale-105'
