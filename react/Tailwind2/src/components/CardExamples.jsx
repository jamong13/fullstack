    ...
    <div className='space-y-8'>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-xs hover:shadow-sm transition">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
            <div className="h-48 bg-linear-to-br from-blue-400 to-purple-500"></div>
            <div className="p-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
            <div className="h-48 bg-linear-to-br from-green-400 to-blue-500"></div>
            <div className="p-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
            <div className="h-48 bg-linear-to-br from-pink-400 to-orange-500"></div>
            <div className="p-6">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            {/* rounded-full 동그라미  */}
            <div className="w-24 h-24 bg-linear-to-br from-blue-400 to-purple-500 rounded-full mx-auto mb-4"></div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            <div className="w-24 h-24 bg-linear-to-br from-green-400 to-blue-500 rounded-full mx-auto mb-4"></div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            <div className="w-24 h-24 bg-linear-to-br from-pink-400 to-orange-500 rounded-full mx-auto mb-4"></div>
