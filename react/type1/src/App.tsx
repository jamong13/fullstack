...
function App() {
  ...
  // a : number, b: number 두개의 숫자를 넣으면 반드시 하나의 숫자 number가 나옴
  ...
  // T라는 타입 만든다. arg T 타입, return 타입도 T 타입
    ...
    <div className="app">
      ...
      <div className="container">
        ...
        <div className="card">
          ...
          <div className="content">
            <p>
              문자열: <strong>{identity<string>("Hello TypeScript")}</strong>
            </p>
            <p>
              숫자: <strong>{identity<number>(42)}</strong>
            </p>
            {/* 함수나 클래스 동작은 동일, 다루는 데이터 타입만 다를 때 */}
          </div>
        </div>
        {/* 유니온 섹션 */}
        <div className="card">
